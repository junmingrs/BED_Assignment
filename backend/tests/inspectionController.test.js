...
describe("inspectionController.getInspections", () => {
    ...
    it("should return inspections for a stall with 200", async () => {
        ...
        inspectionModel.getInspectionsByStallId.mockResolvedValue(
            mockInspections,
        );
        ...
        expect(inspectionModel.getInspectionsByStallId).toHaveBeenCalledWith(
            "stall-1",
        );
    ...
    it("should handle errors and return 500", async () => {
        inspectionModel.getInspectionsByStallId.mockRejectedValue(
            new Error("DB Error"),
        );
...
describe("inspectionController.createInspection", () => {
    ...
    it("should return 400 when score is out of range", async () => {
        const req = {
            params: { stallId: "stall-1" },
            body: { score: 150, hygiene_grade: "A" },
            user: { id: "nea-1" },
        };
        const res = {
            json: jest.fn().mockReturnThis(),
    ...
    it("should create an inspection and return 201 when valid", async () => {
        ...
        const req = {
            params: { stallId: "stall-1" },
            body: { score: 85, remarks: "Good", hygiene_grade: "A" },
            user: { id: "nea-1" },
        };
        const res = {
            json: jest.fn().mockReturnThis(),
...
describe("inspectionController.deleteInspection", () => {
    ...
    it("should delete an inspection and return 200", async () => {
        inspectionModel.deleteInspection.mockResolvedValue({
    ...
    it("should handle errors and return 500", async () => {
        inspectionModel.deleteInspection.mockRejectedValue(
...
describe("inspectionController.getInspectionById", () => {
    ...
    it("should return an inspection with 200", async () => {
        ...
        const mockRequest = {
            input: jest.fn().mockReturnThis(),
            query: jest.fn().mockResolvedValue({ recordset: [mockInspection] }),
        };
        const mockPool = await poolPromise;
...
describe("inspectionController.updateInspection", () => {
    ...
    it("should update an inspection and return 200 when it exists", async () => {
        ...
        const checkRequest = {
            input: jest.fn().mockReturnThis(),
            query: jest.fn().mockResolvedValue({ recordset: [existing] }),
        };
        const updateRequest = {
            input: jest.fn().mockReturnThis(),
        ...
        const selectRequest = {
            input: jest.fn().mockReturnThis(),
            query: jest.fn().mockResolvedValue({ recordset: [updated] }),
        };
        ...
        const req = {
            ...
            body: { score: 90, remarks: "Improved", hygiene_grade: "A" },
            user: { id: "nea-1" },
        };
        const res = {
            json: jest.fn().mockReturnThis(),
