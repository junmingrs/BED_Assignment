...
-- HawkerCentre (must be created before Stall)
...
-- Stall now includes hawker_centre_id
CREATE TABLE Stall
(
...
VALUES
    ...
    ('66666666-6666-6666-6666-666666666666', 'nea@email.com', '$2b$10$BzAI7Mcva8jA7G5ncdKhDuSjg.SE46drC/x2RdMo02k4rTrNCJg9S', 'NEA'),
...
('66666666-6666-6666-6666-666666666666', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY2NvdW50SWQiOiI2NjY2NjY2Ni02NjY2LTY2NjYtNjY2Ni02NjY2NjY2NjY2NjYiLCJyb2xlIjoiTkVBIiwiaWF0IjoxNzg1Mzg5MDYwLCJleHAiOjE3ODU5OTM4NjB9.i_u7-c6PeFHiRsuQJUdhhV8b1aZLG_CTm1Wp_Rkq6Tw', '2026-07-18 19:26:12.047');

-- 3 hawker centres, each under a different operator
...
('CCCCCCC2-CCCC-CCCC-CCCC-CCCCCCCCCCCC', 'Chinatown Complex', '335 Smith St, Singapore 050335', 'B0000001-BBBB-BBBB-BBBB-BBBBBBBBBBBB'),
('CCCCCCC3-CCCC-CCCC-CCCC-CCCCCCCCCCCC', 'Tiong Bahru Market', '30 Seng Poh Rd, Singapore 168898', 'B0000002-BBBB-BBBB-BBBB-BBBBBBBBBBBB');

-- 2 existing stalls linked to Maxwell Food Centre, plus 7 new stalls (3 per centre total)
...
VALUES
    ('20OFF', 'DDDDDDD1-DDDD-DDDD-DDDD-DDDDDDDDDDDD', 'DDDDDDD1-DDDD-DDDD-DDDD-DDDDDDDDDDDD', 20, '2026-07-10', '2026-08-20'),
    ('50OFF', 'DDDDDDD1-DDDD-DDDD-DDDD-DDDDDDDDDDDD', 'DDDDDDD2-DDDD-DDDD-DDDD-DDDDDDDDDDDD', 50, '2026-07-10', '2026-08-20');
